...
int main()
{
    ...
    edge_layer *conv2d_1 = new conv2d(CreateMatrix4d(2,3, 64, 64), 3, 12, 1, 2, 0, 0);
    edge_layer *conv2d_2 = new conv2d(CreateMatrix4d(2,12, 63, 63), 12, 24, 7, 7, 0, 0);
    edge_layer *conv2d_3 = new conv2d(CreateMatrix4d(2,24, 9, 9), 24, 1, 3, 3, 0, 0);
